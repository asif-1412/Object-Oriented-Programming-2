...
namespace TicketReservationSystem
{
    public partial class PassengerUserProfile : UserControl
    {
        ...
        private void profileUpdate_Click(object sender, EventArgs e)
        {
            ...
            User_firstName.ReadOnly = false;
            User_lastName.ReadOnly = false;
            User_email.ReadOnly = false;
            User_phn.ReadOnly = false;
        ...
        private void profileSave_Click(object sender, EventArgs e)
        {
            ...
            User_firstName.ReadOnly = true;
            User_lastName.ReadOnly = true;
            User_email.ReadOnly = true;
            User_phn.ReadOnly = true;
